  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "scale5",
        required: true,
        text: "Do jaké míry se cítíte schopni samostatně zvládat operativní činnosti (podporu) bez asistence ostatních?",
        scaleLabels: { 1: "téměř vůbec samostatně", 5: "zcela samostatně" },
      },
      {
        id: 18,
        type: "radio",
        required: true,
        text: "Jaký časový horizont odhadujete, než byste byli schopni operativu zvládat zcela samostatně?",
        options: [
          "Už teď jsem samostatný/á",
          "Do 1 měsíce",
          "1–3 měsíce",
          "3–6 měsíců",
          "Déle než 6 měsíců",
